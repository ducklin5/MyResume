...
\begin{minipage}[t]{1.0\textwidth}
    \begin{shaded*}
        ...
        \begin{minipage}[t]{\textwidth}
            ...
            \raisebox{.3ex}{\Large$\cdot$ Video Game and Web Software Engineer}
        \end{minipage}
        \vspace{10pt}
        \footnotesize
...
\begin{paracol}{2}
    \begin{minipage}[t]{\leftcolwidth}
        ...
        %\begin{shaded*}
            %\vspace{-1.5em}
            %\section*{\textFocus{Relevant Coursework}}
            %\newcolumntype{C}{>{\centering\arraybackslash}m{0.28\textwidth}}
            %{\setlength{\extrarowheight}{4pt}%
            %\begin{tabular}{CCC}
            %    Calculus & Intro. to Software Engg &  Operating Systems \\
            %    Linear Algebra & Software Requirements &  Games programing \\
            %    Optics & Software Testing & Intro. to Tangible Comput. \\ 
            %\end{tabular}}
        %\end{shaded*}
        \vspace{1em}
    \end{minipage}
    ...
    \begin{minipage}[t]{\rightcolwidth}
        ...
        \begin{minipage}[t]{\textwidth}
            ...
            Familiar: \cvtag{Java} \cvtag{MongoDB} \cvtag{SQLite} \cvtag{Assembly}
            \cvtag{OpenGL} \cvtag{GLSL} 
            \cvtag{LaTeX} \\
            {\normalsize\textbf{Frameworks: }}
            \cvtag{React} \cvtag{Jest} \cvtag{Android} \cvtag{Mockito}\\
            {\normalsize\textbf{OS: }}
            \cvtag{Windows} \cvtag{Arch Linux} \cvtag{Macintosh OS X}
        \end{minipage}
