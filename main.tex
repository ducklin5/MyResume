...
\begin{minipage}[t]{1.0\textwidth}
    \begin{shaded*}
        ...
        \begin{minipage}[t]{\textwidth}
            ...
            \raisebox{.3ex}{\Large$\cdot$ Aspiring Graphics and Computer Vision Engineer}
        \end{minipage}
        \vspace{10pt}
        \footnotesize
...
\begin{paracol}{2}
    ...
    \begin{minipage}[t]{\rightcolwidth}
        ...
        \begin{minipage}[t]{\textwidth}
            ...
            Proficient: \cvtag{C/C++} \cvtag{Python} 
            \cvtag{Javascript} \cvtag{Java} \cvtag{GDscript} \\
            Familiar: \cvtag{MongoDB} \cvtag{SQLite} \cvtag{Assembly}
            \cvtag{Rust} \cvtag{OpenGL} \cvtag{GLSL} 
            \cvtag{LaTeX} \\
